...
def initialize():
    ...
    rows = web.find_elements(By.XPATH,
                             "/html/body/div/span/div/table/tbody/tr[5]/td[3]/div/div[1]/div/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr")
    print len(rows)
    for i in range(2, len(rows) + 1):
        subjson = {}
        element = web.find_element(By.XPATH,
                                   "/html/body/div/span/div/table/tbody/tr[5]/td[3]/div/div[1]/div/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[" + str(
                                       i) + "]")

        array = element.text.replace("  ", "\n").split("\n")
        if "Monday" in array[0] or "Tuesday" in array[0] or "Wednesday" in array[0] or "Thursday" in array[
            0] or "Friday" in array[0] or "Saturday" in array[0]:
